					...
					<div class="col-xs-12">
						<div class="col-quote">
								...
								<div class="col-xs-12">
									<div class="search-title">
										...
										<c:choose>
											...
											<c:when test="${shipmentBean.shipmentHeader.TMmstShpUnit.mmstShpunitCode =='CONTAINER'}">
          										<spring:message code="marketplace.label.shipment.containers"/>
       										</c:when>
											<c:when test="${shipmentBean.shipmentHeader.TMmstShpUnit.mmstShpunitCode =='TRUCK'}">
          										<spring:message code="marketplace.label.shipment.trucks"/>
       										</c:when>
										</c:choose>
									</div>
								</div>
							...
							<c:choose>
								...
								<c:when test="${shipmentBean.shipmentHeader.TMmstShpUnit.mmstShpunitCode =='CONTAINER'}">
									<%@ include file="../shipment/common/common_shipment_part2_container.jspf"%>
								</c:when>
								<c:when test="${shipmentBean.shipmentHeader.TMmstShpUnit.mmstShpunitCode =='TRUCK'}">
									<%@ include file="../shipment/common/common_shipment_part2_truck.jspf"%>
								</c:when>
							</c:choose>

							<!-- shipment part3 content -->
							<%-- <%@ include file="../shipment/common/common_shipment_part3.jspf"%> --%>
							<%@ include file="../shipment/common/common_shipment_asperindo_part3.jspf"%>
							<!-- /shipment part3 content -->
