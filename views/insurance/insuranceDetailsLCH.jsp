...
<spring:url var="shipment_det_submit_url" value="/insuranceDetails/insuranceSubmitLCH" />
						...
						<div class="col-quote">
							...
							<div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane" id="tabShipment">
									<c:choose>
										<c:when test="${((principal.accnRole =='SP')) && (shipmentBean.shipmentHeader.TMmstWorkflow.mmstWorkflowCode =='INSLCH_NEW')}">
											<%@ include file="../service/bidDataEntry.jsp"%>
										</c:when>
										<c:when test="${((principal.accnRole =='SP')) && (shipmentBean.shipmentHeader.TMmstWorkflow.mmstWorkflowCode !='INSLCH_NEW')}">
											<%@ include file="../service/bidDetails.jsp"%>
										</c:when>
										<c:when test="${(principal.accnRole =='CUS' || principal.accnRole =='ADMIN') && (shipmentBean.shipmentHeader.TMmstWorkflow.mmstWorkflowCode !='INSLCH_NEW')}">
											<%@ include file="../customer/customerBidDetails.jsp"%>
										</c:when>
									</c:choose>
									<%@ include file="../shipment/common/common_insurance_details_LCH.jspf"%>
								</div>
